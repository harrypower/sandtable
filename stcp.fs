...
: processhttp ( "ccc" -- ) \ this is called from inetd and will simply get the stdin message sent from inetd and return a message
  try
    ...
    *http* to http?cmdline?
    s\" nohup sudo sh -c \"echo \"command=fastcalibration&xquick=0&yquick=0\" | /home/debian/sandtable/stcp.fs -e \"processcmdline\" \" &> /home/debian/sandtable/stcpcmdline.data & "
