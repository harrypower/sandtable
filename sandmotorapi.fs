...
: configure-stuff ( -- nflag ) \ nflag is false if configuration happened other value if some problems
  ...
  configured? 0 = if
    ...
    %100 %00000001111100000011 1 1000 0 0 %00111000000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    2 ymotor quickreg!
    %100 %00000001111100000011 1 1000 0 0 %00110110000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    3 ymotor quickreg!
    %100 %00000000011100000011 1 1000 0 0 %00110100000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    4 ymotor quickreg!
    %100 %00000000001100000011 1 1000 0 0 %00110001000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    5 ymotor quickreg!
    %100 %00000000001100000011 1 1000 0 0 %00110001000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
