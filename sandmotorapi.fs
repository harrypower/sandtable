...
0 constant xm
1 constant ym
3e fvariable xthreshold xthreshold f! \ x threshold for home
4.8e fvariable ythreshold ythreshold f! \ y threshold for home
...
: configure-stuff ( -- nflag ) \ nflag is false if configuration happened other value if some problems
  ...
  configured? 0 = if
    ...
    0 xmotor quickreg!
    %100 %00000000011000000000 1 1000 0 0 %00110001000000101000000010010011 %0000000000000000000000000 %0111100000101011111111
    1 xmotor quickreg!
