...
40 value silentspeed-usleep \ wait time in useconds for silent step operation
850 value calspeed
256 value calsteps
...
: configure-stuff ( -- nflag ) \ nflag is false if configuration happened other value if some problems
  ...
  configured? 0 = if
    ...
    %100 %00000000010100000000 1 1000 0 0 %00110001000000101000000010010011 %0000000000000000000000000 %0111100000101011111111
    2 xmotor quickreg!
    %100 %00000000010000000000 1 1000 0 0 %00110001000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    3 xmotor quickreg!
    %100 %00000000001100000000 1 1000 0 0 %00110001000000001000000010010011 %0011011000000000000000000 %0111100000101011111111
    4 xmotor quickreg!
    %100 %00000000001000000000 1 1000 0 0 %00110001000000001000000010010011 %0011101100000000000000000 %0111100000101011111111
    5 xmotor quickreg!
    %100 %00000000000100000000 1 1000 0 0 %00110001000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    6 xmotor quickreg!
