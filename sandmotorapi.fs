...
: configure-stuff ( -- nflag ) \ nflag is false if configuration happened other value if some problems
  ...
  configured? 0 = if
    ...
    %100 %00000000000100000000 1 1000 0 0 %00110101000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    2 xmotor quickreg!
    %100 %00000000011100000000 1 1000 0 0 %00110100000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    3 xmotor quickreg!
    ...
    %100 %00000001111100000011 1 1000 0 0 %00110101000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    2 ymotor quickreg!
    %100 %00000001111100000011 1 1000 0 0 %00110100000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    3 ymotor quickreg!
    %100 %00000000011100000011 1 1000 0 0 %00110011000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
    4 ymotor quickreg!
    %100 %00000000001100000011 1 1000 0 0 %00110010000000001000000010010011 %0000000000000000000000000 %0111100000101011111111
