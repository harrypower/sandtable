...
: configure-stuff ( -- nflag ) \ nflag is false if configuration happened other value if some problems
  ...
  configured? 0 = if
    ...
    4 xmotor quickreg!
    %100 %00000000000100000010 1 1000 0 0 %00110001000000001000000010010011 %0010110000000000000000000 %0111100000101011111111
    5 xmotor quickreg!
    %100 %00000000000100000001 1 1000 0 0 %00110001000000001000000010010011 %0010110000000000000000000 %0111100000101011111111
    6 xmotor quickreg!
