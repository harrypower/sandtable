...
0x6c %00010000000010101000000010010110  mymotorx putreg . .
( diss2g 0, dedge 0, intpol 1, mres %0000, sync 0, vhighchm 1, vhighfs 0, vsense 1, TBL %01, chm 0, rndtf 0, disfdcc 0, TFD 0, HEND 0, HSTRT 0,TOFF %110)
...
( TPWMTHRS )
0x70 %0111100000000100010000            mymotorx putreg . .
( freewheel %01 ,pwm_symmetric %1 ,pwm_autoscale %1 ,PWM freq %10 ,PWM_GRAD %1 ,PWM_AMPL %00010000 )
