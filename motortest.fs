...
0x6d %1011101100000000100100000         mymotorX putreg . .
( sfilt 0,sgt %1110110 -10 , seimin 0, sedn 00, semax 10, seup 01, semin 0)
0x14 200                                mymotorX putreg . .
( TCOOLTHRS )
0x15 200                                mymotorX putreg . .
( THIGH )
