...
0x6c %00010000000000101100000000000010  mymotorx putreg . .
( diss2g 0, dedge 0, intpol 1, mres %0000, sync 0, vhighchm 0, vhighfs 0, vsense 1, TBL %01, chm 1, rndtf 0, disfdcc 0, TFD 0, HEND 0, HSTRT 0,TOFF %10)
...
0x6d %0000000000000000100100000         mymotorX putreg . .
( sfilt 0,sgt 0, seimin 0, sedn 00, semax 10, seup 01, semin 0)
0x14 %100000                            mymotorX putreg . .
( TCOOLTHRS )
0x15 %10000000                          mymotorX putreg . .
( THIGH )
